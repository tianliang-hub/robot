...
export const CUSTOMER_BINDINGS = [
  { id: "A", name: "顾客A", tableId: "1", anchorModelName: "顾客A" },
  { id: "B", name: "顾客B", tableId: "1", anchorModelName: "顾客B" },
...
export const SCENE_POINTS = {
  chef: new THREE.Vector3(0, 0, -9.6),
  ...
  fridgePoint: new THREE.Vector3(8.2, 0, -2.6),
  tables: {
    "1": new THREE.Vector3(-5, 0, 4),
    "2": new THREE.Vector3(5, 0, 4)
  }
};
...
export const SERVICE_POINTS = {
  ...
  fridgeService: new THREE.Vector3(7.2, 0, -2.7),
  cleanupWaypoints: {
    "1": [new THREE.Vector3(-6.8, 0, 1.2)],
    "2": [new THREE.Vector3(6.8, 0, 1.2)]
  },
  tableService: {
    "1": new THREE.Vector3(-5.0, 0, 2.85),
    "2": new THREE.Vector3(5.0, 0, 2.85)
  }
};
...
export const STATIC_MODEL_PLAN = [
  ...
  { name: "sofa", url: "/models/environment/sofa.glb", pos: [-3.4, 0, 4.0], scale: 0.9, rotationY:-Math.PI / 2, stage: 1, importance: "medium" },
  { name: "sofa_right", url: "/models/environment/sofa.glb", pos: [-6.6, 0, 4.0], scale: 0.9, rotationY:Math.PI / 2, stage: 1, importance: "medium" },
  { name: "散台沙发-左", url: "/models/environment/sofa.glb", pos: [3.4, 0, 4.0], scale: 0.75, rotationY: Math.PI / 2, stage: 1, importance: "medium" },
  { name: "散台沙发-右", url: "/models/environment/sofa.glb", pos: [7.2, 0, 4.0], scale: 0.75, rotationY: -Math.PI / 2, stage: 1, importance: "medium" },
  ...
  { name: "oven", url: "/models/environment/oven.glb", pos: [-7.5, 0, -10.4], scale: 0.9, rotationY: THREE.MathUtils.degToRad(40), stage: 1, importance: "high" },
  { name: "fridge", url: "/models/environment/fridge.glb", pos: [8.2, 0, -6.6], scale: 0.9, rotationY: THREE.MathUtils.degToRad(-18), stage: 1, importance: "high" },
  { name: "torii_gate", url: "/models/environment/torii_gate.glb", pos: [-5.3, 0, 10.4], scale: 0.9, rotationY: Math.PI, stage: 2, importance: "medium" },
  ...
  { name: "顾客A", url: "/models/customers/customer_a.glb", pos: [-6.4, 0, 4.0], scale: 0.8, rotationY: Math.PI / 2, stage: 2, importance: "medium" },
  { name: "顾客B", url: "/models/customers/customer_b.glb", pos: [-3.7, 0, 3.9], scale: 0.8, rotationY: -Math.PI / 2, stage: 2, importance: "medium" },
  { name: "顾客C", url: "/models/customers/customer_c.glb", pos: [6.6, 0, 4.0], scale: 0.8, rotationY: -Math.PI / 2, stage: 2, importance: "medium" }
];
